...
Real-time weather/crypto/news features require the following optional environment variables:

- `OPENWEATHER_API_KEY`
- `NEWS_API_KEY`
- `COINGECKO_API_KEY` (only needed if you use CoinGecko Pro)

Without them, SEVEN falls back to general local responses.
